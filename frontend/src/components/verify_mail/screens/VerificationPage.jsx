...
export default function EmailVerificationPage() {
    ...
    return (
        <div className="min-h-screen w-full relative bg-[#212121] flex flex-col items-center justify-center p-4">
            {/* Background Gradient */}
            <div
            ...
            <div className="relative z-10 w-full max-w-md rounded-3xl bg-neutral-900 shadow-xl p-8 border border-neutral-800">
                ...
                {step === 1 ? (
                    <form onSubmit={handleSendCode} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 rounded-lg bg-neutral-800 border border-neutral-700 text-white focus:ring-2 focus:ring-[#E43137] focus:border-transparent outline-none transition-all"
                                disabled={loading}
                            />
                        </div>
                        <button
                    ...
                    <form onSubmit={handleVerify} className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-neutral-300 mb-1.5">Mã xác thực</label>
                            <input
                                type="text"
                                value={code}
                                onChange={(e) => setCode(e.target.value)}
                                placeholder="Nhập mã 6 số"
                                className="w-full px-4 py-2.5 rounded-lg bg-neutral-800 border border-neutral-700 text-white focus:ring-2 focus:ring-[#E43137] focus:border-transparent outline-none transition-all text-center tracking-widest text-lg"
                                disabled={loading}
                            />
                        </div>
                        ...
                        <div className="text-center mt-4">
                            <p className="text-sm text-neutral-400">
                                ...
                                <button
                                    ...
                                    className="text-[#E43137] hover:underline disabled:text-neutral-600 disabled:no-underline font-medium"
                                >
            ...
            <div className="relative z-10 mt-6 max-w-md w-full text-center">
                <div className="bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 rounded-xl p-4">
                    <h3 className="text-neutral-300 text-sm font-medium mb-2">Lưu ý quan trọng:</h3>
                    <ul className="text-xs text-neutral-400 space-y-1.5 text-left list-disc list-inside px-2">
