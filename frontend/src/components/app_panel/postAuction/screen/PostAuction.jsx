...
export default function PostAuction() {
    ...
    React.useEffect(() => {
        PostAuctionApi.getCategories()
            ...
            .catch((err) => {
                ...
                setUploadStatus({ type: "error", message: t(err.message || 'Failed_to_load_categories')});
            });
    }, [t]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setUploadStatus({
                type: "success",
                message: t('Auction_created_success', { itemId: result.item.itemId })
            });
            ...
            setUploadStatus({
                type: "error",
                message: t(error.message || "Failed_to_create_auction")
            });
        } finally {
            setLoading(false);
        }
